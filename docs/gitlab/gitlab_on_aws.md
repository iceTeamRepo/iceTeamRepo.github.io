    ...
    - 설치
        ...
        - 2 > Network 구성
            1. VPC 생성
                ...
                ![image05.png](../assets/img/gitlab/gitlab_on_aws/image_5.png)
            ...
            2. Subnet 생성
                ...
                ![image06.png](../assets/img/gitlab/gitlab_on_aws/image_6.png)
                    ...
                    - **설정 과정**
                        ...
                        10. 가용 영역 배치
                            - 가용 영역을 수동으로 선택하고, **Replica 2**는 다른 가용 영역을 선택
                                ...
                                ![image07.png](../assets/img/gitlab/gitlab_on_aws/image_7.png)
        ...
        - 8 > Launch Template 생성 및 ASG 생성
            ...
            - CloudWatch에서 스케일링 정책 설정
                - Scale Up Policy
                    ...
                    ![image08.png](../assets/img/gitlab/gitlab_on_aws/image_8.png)
                    
                    - 조건: CPUUtilization 60% 이상 -> 1 capacity unit 추가
                    - 정책 이름: `Scale Up Policy`
                - Scale Down Policy
                    
                    ![image09.png](../assets/img/gitlab/gitlab_on_aws/image_9.png)
